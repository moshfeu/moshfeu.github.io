...
<iframe
  height="265"
  scrolling="no"
  title="Align flexbox last item to right"
  src="//codepen.io/moshfeu/embed/aGdNEZ/?height=265&theme-id=0&default-tab=css,result&embed-version=2"
  frameborder="no"
...
>
  See the Pen{" "}
  <a href="https://codepen.io/moshfeu/pen/aGdNEZ/">
    Align flexbox last item to right
  </a>{" "}
...
<a href="https://stackoverflow.com/q/49965479/863110" target="_blank">
